import * as MPromise from 'mpromise';
type MongoosePromise<T> = MPromise<T>;
...
declare type MongooseThenable = typeof mongoose & _MongooseThenable;
declare interface _MongooseThenable {
  /**
 ...
 */
declare interface QueryStream extends stream.Stream {
  /**
 ...
 */
declare abstract class ConnectionBase extends events.EventEmitter {
  /**
...
/** See the node-mongodb-native driver instance for options that it understands. */
declare interface ConnectionOpenOptions extends ConnectionOptionsBase {
...
/** See the node-mongodb-native driver instance for options that it understands. */
declare interface ConnectionOpenSetOptions extends ConnectionOptionsBase {
  /**
...
declare interface Collection extends CollectionBase {
  /**
...
declare interface ConnectOptions extends ConnectionOpenOptions, ConnectionOpenSetOptions {}
 ...
 */
declare interface QueryCursor<T extends Document> extends stream.Readable {
  /**
 ...
 */
declare class MongooseDocument {
 ...
 */
declare class DocumentQuery<T, DocType extends Document> extends mquery {
  /**
...
declare interface QueryFindOneAndUpdateOptions extends QueryFindOneAndRemoveOptions {
...
declare interface QueryUpdateOptions extends ModelUpdateOptions {
  /**
 ...
 */
declare interface _MongoosePromise<T> extends MongoosePromise<T> {}
declare interface Promise<T> extends MongoosePromise<T> {}
 ...
 */
declare interface Model<T extends Document> extends NodeJS.EventEmitter {
  /**
   * Model constructor
...
declare interface Document extends MongooseDocument, NodeJS.EventEmitter {
...
declare interface ModelFindOneAndUpdateOptions extends ModelFindByIdAndUpdateOptions {
  /** Field selection. Equivalent to .select(fields).findOneAndUpdate() */
  fields?: Object | string;
  /** puts a time limit on the query - requires mongodb >= 2.6.0 */
  maxTimeMS?: number;
 ...
 */
declare interface CollectionBase extends mongodb.Collection {
  /*
